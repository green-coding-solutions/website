...
If you do not know what IPMI is and how to read the data, check out our [Metrics Provider for IPMI](https://docs.green-coding.io/docs/measuring/metric-providers/psu-energy-ac-ipmi-machine/) in the [Green Metrics Tool](/projects/green-metrics-tool/).
...
If you cannot measure you have to estimate. We have written a prior [blog article](/blog/specpower-model-with-xgboost-open-sourced/) about how this can be done with an
