...
Today we have have released the `0.1-beta` version of our [Green Metrics Tool](https://github.com/green-coding-services/green-metrics-tool/releases/tag/v0.1-beta)
